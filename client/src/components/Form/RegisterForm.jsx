    ...
    <Form onSubmit={handleSubmit}>
      ...
      <div className="form-group">
        ...
        >
          ...
          <option value="БҚ-2304">БҚ-2304</option>
          <option value="БҚ-2305">БҚ-2305</option>
          <option value="БҚ-2404">БҚ-2404</option>
          <option value="БҚ-2405">БҚ-2405</option>
          <option value="БҚ-2504">БҚ-2504</option>
          <option value="БҚ-2505">БҚ-2505</option>
        </select>
